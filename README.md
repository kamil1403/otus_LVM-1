...
• Скопировал файлы в /lvm, создал снепшот, удалил файлы из /lvm, а затем восстановил их из снэпшота. Результат см. на скриншоте ["snapshot"](https://github.com/kamil1403/otus_LVM-1/blob/main/screenshots/snapshot.png)  
