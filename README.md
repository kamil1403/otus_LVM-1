...
• Скопировал файлы в /lvm, создал снепшот, удалил файлы из /lvm, а затем восстановил их из снэпшота. Результат см. на скриншоте 🖼️ ["snapshot"](https://github.com/kamil1403/otus_LVM-1/blob/main/screenshots/snapshot.png)  
• Смонтировал том "test" в каталог /lvm.   
Видно, что после перезагрузки том смонтировался корректно. Результат см. на скриншоте 🖼️ ["fstab"](https://github.com/kamil1403/otus_LVM-1/blob/main/screenshots/fstab.png)  
